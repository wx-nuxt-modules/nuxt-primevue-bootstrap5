      ...
      <tr role="row" v-bind="ptm('headerRow')">
        <template v-for="(col, i) of columns" :key="columnProp(col, 'columnKey') || columnProp(col, 'field') || i">
          <DTHeaderCell
            ...
            @filter-overlay-show="$emit('filter-overlay-show', $event)"
            @filter-overlay-hide="$emit('filter-overlay-hide', $event)"
            :unstyled="unstyled"
            :pt="pt"
          />
        </template>
        ...
        <template v-for="(col, i) of columns" :key="columnProp(col, 'columnKey') || columnProp(col, 'field') || i">
          ...
          >
            ...
            <DTColumnFilter
              ...
              @constraint-remove="$emit('constraint-remove', $event)"
              @apply-click="$emit('apply-click', $event)"
              @overlay-show="$emit('filter-overlay-show', $event)"
              @overlay-hide="$emit('filter-overlay-hide', $event)"
              :column="col"
              :unstyled="unstyled"
              :pt="pt"
            />
